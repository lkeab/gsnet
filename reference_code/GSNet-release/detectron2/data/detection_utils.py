...
def read_image(file_name, format=None):
    ...
    #if 'occ' in file_name:
    #    file_name = 'datasets/coco/val2017/'+file_name.split('occ2017/', 1)[1]
...
def transform_instance_annotations(
    ...
    #print('transform:', transforms.transforms)
    ...
    #print('bbox after:', annotation["bbox"])
    ...
    if "keypoints" in annotation:
        #print('before annotation keypoint:', annotation["keypoints"])
        keypoints = transform_keypoint_annotations(
            annotation["keypoints"], transforms, image_size, keypoint_hflip_indices
        )
        annotation["keypoints"] = keypoints
        #print('after annotation keypoint:', annotation["keypoints"])
...
def annotations_to_instances(annos, image_size, mask_format="polygon"):
    ...
    #print('enter classes=============:', classes)
    #print('anno:', annos[0])
    if len(annos) and "pose" in annos[0]:
        #print('enter=====================pose_here')
        poses = [obj.get("pose", []) for obj in annos]
...
def build_transform_gen(cfg, is_train):
    ...
    pretrained = True
    if is_train and (not pretrained):
