...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _eval_predictions(self, tasks, predictions):
        ...
        print('predictions 0 instances:', len(predictions[0]['instances']))
        print('predictions 0 instances keys:', predictions[0]['instances'][0].keys())
...
def instances_to_coco_json(instances, img_id):
    ...
    translation = instances.predict_trans.tolist()
    rotation = instances.predict_rotation.tolist()
    predict_vertices = instances.predict_vertices.tolist() 
    ...
    for k in range(num_instance):
        ...
        if has_keypoints:
            ...
            result["car_vertices"] = predict_vertices[k]
